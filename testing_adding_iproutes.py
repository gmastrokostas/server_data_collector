...
import ipaddress
#vars
save_yml_location = "/home/seeker/stash/git_projects/server_data_collector/hostvars"
hostname_file = 'inventory'
checK_file = os.path.isfile(hostname_file)
print(checK_file)
hostname_list = []
msg = """
Please make sure a file called inventory
exists in the same directory you are running
your script from.
"""
...
#dynamic_routes_list = []; static_routes_list  = []
#print(dynamic_routes_list)
#print(static_routes_list)
cli_string_1 = "ip route add"; cli_string_2 = "/"; cli_string_3 = "via "; cli_string_4 = "dev "
